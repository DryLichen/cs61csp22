...
main:
    ...
    jal pow
    li t0, 128 
    beq a0, t0, next_test # verifies that pow returned the right value
    la a0, pow_string
    j failure
...
inc_arr_loop:
    ...
    # Also ask yourself this: why don't we need to preserve t1?(Because we won't use t1 after the function call)
    add s2, t0, x0
    #
    jal helper_fn
    # FIXME Restore t0
